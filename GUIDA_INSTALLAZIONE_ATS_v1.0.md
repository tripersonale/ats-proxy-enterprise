...
**Versione 1.1 — 24 Maggio 2026 — Testata su VM reale + batteria test completa**
...
| ATS | 9.2.13 LTS (compilato) | Chiude 11 CVE, non nei repo 26.04, Debian lo sta rimuovendo |
...
- [ ] ATS 9.2.13 compilato senza errori
...
| UFW allow + ACL deny | ⚠️ 200 (localhost) | **localhost bypassa anche le ACL!** |
