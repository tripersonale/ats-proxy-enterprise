...
ReadWritePaths=${INSTALL_PREFIX}/etc/trafficserver ${INSTALL_PREFIX}/var/trafficserver ${INSTALL_PREFIX}/var/log/trafficserver /etc/ats-proxy /var/log/ats-health.log /run/trafficserver
PrivateTmp=true
PrivateDevices=true
