...
EXPECTED_PLUGIN_V30_SO_SHA256="157b97f85ab9524d2cac978c8c27df79cdaa64c0b9d4dc5590fede9123df4502"
EXPECTED_PLUGIN_V30_C_SHA256="05e93d43bf0d0ff8b75dee59c06a3932b3ef79e5d05e83efa72276476f6bf1ae"
...
[ -f GUIDE/GUIDA_INSTALLAZIONE.md ] || err "GUIDA_INSTALLAZIONE.md missing"
[ -f GUIDE/MANUALE_OPERATIVO.md ] || err "GUIDA_OPERATIVA.md missing"
[ -f src/ats_proxy_filter_v30.c ] || err "src/ats_proxy_filter_v21.c missing"
[ -f bin/ats_proxy_filter_v30.so ] || err "bin/ats_proxy_filter_v21.so missing"
[ -f src/ats_proxy_filter_v30.c ] || err "src/ats_proxy_filter_v30.c missing"
[ -f bin/ats_proxy_filter_v30.so ] || err "bin/ats_proxy_filter_v30.so missing"
...
actual_so_sha="$(sha256sum bin/ats_proxy_filter_v30.so | awk '{print $1}')"
actual_c_sha="$(sha256sum src/ats_proxy_filter_v30.c | awk '{print $1}')"
actual_v30_so_sha="$(sha256sum bin/ats_proxy_filter_v30.so | awk '{print $1}')"
actual_v30_c_sha="$(sha256sum src/ats_proxy_filter_v30.c | awk '{print $1}')"
...
[ "$actual_v30_so_sha" = "$EXPECTED_PLUGIN_V30_SO_SHA256" ] || err "Plugin v3 .so SHA256 mismatch: $actual_v30_so_sha"
[ "$actual_v30_c_sha" = "$EXPECTED_PLUGIN_V30_C_SHA256" ] || err "Plugin v3 .c SHA256 mismatch: $actual_v30_c_sha"

grep -q "$EXPECTED_PLUGIN_SO_SHA256" ARTIFACTS.md || err "ARTIFACTS.md does not contain plugin SHA256"
grep -q "$EXPECTED_PLUGIN_V30_SO_SHA256" ARTIFACTS.md || err "ARTIFACTS.md does not contain plugin v3 SHA256"
grep -q 'bin/ats_proxy_filter_v30.so' env/ats-proxy.env.example || err "env template does not point to versioned plugin"
...
ok "Plugin v3 .so/.c SHA256 matches manifest"
